...
$("a").each(function() {
    if ($(this).text() == "Active") {
        if (String(sessionStorage.getItem("prevdata")) != String($(this).attr('data-count')) && $(this).attr('data-count') != null) {
            var options = {
                body: 'Previous = ' + sessionStorage.getItem("prevdata") + ' and Now =' + $(this).attr('data-count') + '.',
                dir: 'ltr',
                icon: 'https://img1.pnghut.com/t/17/10/24/WJ2MSxDjhC/number-symbol-market-icon-green-fiverr.jpg'
            }
            var n = new Notification('Buyer Request Alert', options);
            sessionStorage.setItem("prevdata", $(this).attr('data-count'));
